  ...
  render() {
    return (
      <div class='borto-log-panel'>
        <div class='borto-log-container'>
          {(() => {
            if (this.level === -1) {
              return <pre style='height: 100%;'>{this.rawLog}</pre>;
            } else {
              return (
                        ...
                        <tr style={`display: ${this.priority[m.type] >= this.level ? 'table-row' : 'none'};`}>
                          ...
                          <td class='borto-log-cell column2'>
                            <div class='borto-log-content column2'>
                              <div class='borto-log-fit-content column2' onclick={() => m.file.open()}>{m.file.fullname}</div>
                            </div>
                          </td>
