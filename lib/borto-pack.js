...
export async function run(e) {
  ...
  switch (terminal) {
    ...
    case 'GNOME':
      ...
      var args = ['-t', name, loaderPath, ...exeArgs];
      break;
    case 'xterm':
      var command = 'xterm';
    ...
    case 'Konsole':
      var command = 'konsole';
      var args = ['-e', pyCompiler, loaderPath, ...exeArgs];
      break;
    case 'Xfce':
      var command = 'xfce4-terminal';
      var args = ['-T', name, '--command', pyCompiler, loaderPath, ...exeArgs];
      break;
    case 'Pantheon':
      var command = 'pantheon-terminal';
      var args = ['-e', pyCompiler, loaderPath, ...exeArgs];
      break;
    case 'URxvt':
      var command = 'urxvt';
