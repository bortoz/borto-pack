...
export default class Testcase {
  ...
  exit(code, signal) {
    ...
    if (this.errorFlag) {
      ...
      this.displayOutput = this.outputData;
    } else if (signal || code) {
      this.result = 'error';
      this.message = signal || 'RTE';
      this.displayOutput = this.errorData;
    } else {
      this.result = 'success';
